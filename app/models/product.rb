class Product < ActiveRecord::Base
  attr_accessible :title, :description, :image_url, :price, :weighting, :stock, :dimensions_attributes, :category_ids, :additional_option_ids, :dimension_ids, :sku, :part_number
