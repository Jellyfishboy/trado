module ApplicationHelper
    ...
    # Excluding VAT DOM elements for prices, when tax breakdown has been activated in the store settings
    #
    # @return [String] HTML elements
    def excluding_tax
      "<span class='ex-tax'>Ex VAT</span>".html_safe if Store::settings.tax_breakdown
    end
