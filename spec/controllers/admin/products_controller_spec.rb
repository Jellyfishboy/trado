    ...
    describe 'PATCH #update' do
        ...
        context "with valid attributes" do
            ...
            it "should save the product" do
                patch :update, id: product.id, product: attributes_for(:product_sku, category_id: category.id, name: 'Product #2', featured: true)
                product.reload
            ...
            it "should redirect to products#index" do
                patch :update, id: product.id, product: attributes_for(:product_sku, category_id: category.id)
                expect(response).to redirect_to(admin_products_url)
            end
        end
        ...
        context "with invalid attributes" do
            before(:each) do
                patch :update, id: product.id, product: attributes_for(:invalid_product, category_id: category.id)
            end
