...
describe Sku do
    ...
    describe 'Validation variant duplication' do
        ...
        context "if the assocaited sku variants has a duplicated name" do
            ...
            let!(:sku) { build(:sku, active: true, product_id: product.id) }
            ...
            before(:each) do
                ...
                build(:sku_variant, name: '500g', variant_type_id: color_variant_type.id, sku_id: sku.id)
                build(:sku_variant, name: 'Blue', variant_type_id: color_variant_type.id, sku_id: sku.id)
            end
