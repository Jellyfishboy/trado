...
describe Notification do
    ...
    context 'skus and users can be associated to a notification' do
      ...
      it 'should allow different models to be associated' do
        sku_notification = create(:sku_notification, email: 'qwerty21@gmail.com', notifiable: sku)
        expect(sku_notification.valid?).to be true
        notification = build(:user_notification, email: 'qwerty21@gmail.com', notifiable: user)
    ...
    context 'skus and users can be associated to a notification' do
      ...
      it 'should allow a second association if the first was sent years ago' do
        expect(create(:user_notification, email: 'qwerty22@gmail.com', notifiable: user, sent_at: 2.years.ago, created_at: 3.years.ago).valid?).to be true
        notification = build(:user_notification, email: 'qwerty22@gmail.com', notifiable: user)
        expect(notification.valid?).to be true
        expect(notification.save).to be true
      end
    end
