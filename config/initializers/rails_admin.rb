# RailsAdmin config file. Generated on August 21, 2013 10:08
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Gimson Robotics', 'Admin']
  ...
  config.excluded_models = ["Accessorisation", "LineItem", "Categorisation", "Dimensional"]
  ...
  # config.model 'Accessorisation' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your accessorisation.rb model definition
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your categorisation.rb model definition
  ...
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  #     configure :weighting, :integer 
  #     configure :stock, :integer 
